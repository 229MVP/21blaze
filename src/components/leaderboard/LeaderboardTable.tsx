...
import React from 'react'; import { FlatList,Text,View,StyleSheet } from 'react-native'; import { BlazePanel } from '../ui/BlazePanel'; import { LeaderboardRow } from './LeaderboardRow'; import { colors,spacing } from '../../theme/uiKit';
